...
print(f"Please insert your Shodan api key.")
print(f"Get your Shodan api key here: https://account.shodan.io/\n")
shodan_key = input(f"Key: ")
self.api = shodan.Shodan(shodan_key)
print('')
self.Type = print(f"Shodan Searcher. (massive searcher)\n[2] IP Lookup. (Get info about an IP)")
self.T = input('\nEnter a number: ')
